...
flags.DEFINE_integer('restart_threshold', None,
                     'Restart training if distribution of training data in clusters is skewed by this amount')
...
flags.DEFINE_bool('image_space_centroids', True,
...
def main(_):
    ...
    # some datasets like svhn have very unbalanced label distribution. this does not work well here, so, we have to
    # balance that.
