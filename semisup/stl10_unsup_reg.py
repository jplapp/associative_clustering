...
def main(_):
    ...
    # unlabeled_train_images, _ = dataset_tools.get_data('unlabeled', max_num=10000)  # extra images left for
    # exploration
    ...
    with tf.Session(graph=graph) as sess:
        ...
        for step in range(FLAGS.max_steps):
            ...
            _, train_loss, centroids, unsup_emb, reg_unsup_emb, estimated_error, p_ab, p_ba, p_aba, reg_loss = sess.run(
                    [train_op, model.train_loss, t_sup_emb, t_unsup_emb, t_reg_unsup_emb, model.estimate_error,
                     model.p_ab,
